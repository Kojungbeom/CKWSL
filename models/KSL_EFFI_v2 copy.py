...
class EfficientNet(nn.Module):
    def __init__(self):
        ...
        self._blocks.append(MBConvBlock(3, 2, 4, 16, 24, 0.25, False))
        self._blocks.append(MBConvBlock(3, 1, 4, 24, 24, 0.25, True))
        ...
        self._blocks.append(MBConvBlock(5, 2, 4, 24, 40, 0.25, False))
        self._blocks.append(MBConvBlock(5, 1, 4, 40, 40, 0.25, True))
        self._blocks.append(MBConvBlock(3, 2, 4, 40, 80, 0.25, False))
        self._blocks.append(MBConvBlock(3, 1, 4, 80, 80, 0.25, True))
        self._blocks.append(MBConvBlock(3, 1, 4, 80, 80, 0.25, True))
